...
export const postSign = (payload) => async (dispatch) => {
    ...
    try {
        let res = await axios.post(
            `https://muddy-garb-moth.cyclic.app/user/signup`,
            payload
        );
...
export const postLogin = (payload) => async (dispatch) => {
    ...
    try {
        let res = await axios.post(
            `https://muddy-garb-moth.cyclic.app/user/login`,
            payload
        );
...
export const getDetailsFromToken = (payload) => async (dispatch) => {
    try {
        let res = await axios.post(
            `https://muddy-garb-moth.cyclic.app/user/verify`,
            payload
        );
...
export const getAllUsers = () => async (dispatch) => {
    try {
        let res = await axios.get(
            `https://muddy-garb-moth.cyclic.app/user`
        );
